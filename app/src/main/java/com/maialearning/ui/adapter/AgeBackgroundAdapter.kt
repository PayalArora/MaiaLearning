...
class AgeBackgroundAdapter(var list:  ArrayList<CareerFactsheetResponse.AgeBreakdownItem>?, var arr:Array<Int>)  : RecyclerView.Adapter<AgeBackgroundAdapter.ViewHolder>() {
