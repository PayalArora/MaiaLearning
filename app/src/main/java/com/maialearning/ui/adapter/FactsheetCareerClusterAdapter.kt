...
class FactsheetCareerClusterAdapter(var list: ArrayList<CareerFactsheetResponse.CategoriesItem>?)  : RecyclerView.Adapter<FactsheetCareerClusterAdapter.ViewHolder>() {
