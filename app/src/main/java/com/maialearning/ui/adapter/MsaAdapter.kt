...
import com.maialearning.model.CountyItem
import com.maialearning.model.MsaItem
import com.maialearning.model.StateItem


class MsaAdapter   (
    val context: Context,
    var arrayListOut: ArrayList<MsaItem>,
        var click:(item:MsaItem)->Unit
) : RecyclerView.Adapter<MsaAdapter.ViewHolder>() {
    /**
