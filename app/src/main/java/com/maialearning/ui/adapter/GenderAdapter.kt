...
import com.maialearning.databinding.GenderItemBinding
import com.maialearning.model.CareerFactsheetResponse
import com.maialearning.util.format
import kotlin.math.roundToInt

class GenderAdapter(var list:  ArrayList<CareerFactsheetResponse.GenderBreakdownItem>?, var arr:Array<Int>)  : RecyclerView.Adapter<GenderAdapter.ViewHolder>() {

    /**
     * Provide a reference to the type of views that you are using
     * (custom ViewHolder).
     */
    class ViewHolder(val binding: GenderItemBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = GenderItemBinding.inflate(inflater, viewGroup, false)
