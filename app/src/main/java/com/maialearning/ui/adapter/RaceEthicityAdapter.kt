...
import com.maialearning.databinding.EthniItemBinding
import com.maialearning.model.CareerFactsheetResponse
import com.maialearning.util.format
import kotlin.math.roundToInt
import kotlin.math.roundToLong

class RaceEthicityAdapter(var list:  ArrayList<CareerFactsheetResponse.RaceEthnicityBreakdownItem>?, var arr:Array<Int>)  : RecyclerView.Adapter<RaceEthicityAdapter.ViewHolder>() {

    /**
     * Provide a reference to the type of views that you are using
     * (custom ViewHolder).
     */
    class ViewHolder(val binding: EthniItemBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = EthniItemBinding.inflate(inflater, viewGroup, false)
