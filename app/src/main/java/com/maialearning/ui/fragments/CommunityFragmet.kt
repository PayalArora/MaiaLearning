...
class CommunityFragmet : Fragment() {
    ...
    private fun initData(){
        ...
        val communityModel4= CommunityModel("Female","51%","","#C1345F")
        listData.add(communityModel4)
        val communityModel5= CommunityModel("Male","49%","","#348FC1")
        listData.add(communityModel5)
        val communityModel6= CommunityModel("Total Students","42,501","","#54575F")
        listData.add(communityModel6)
        val communityModel7= CommunityModel("In-state","72%","","#24418E")
        listData.add(communityModel7)
        val communityModel8= CommunityModel("Out-of-State","51%","","#804053")
        listData.add(communityModel8)
        val communityModel9= CommunityModel("International","14%","","#C17034")
        ...
        val communityModela2= CommunityModel("Hispanic Latino","93%","#80804053","")
        listDataProgress.add(communityModela2)
        val communityModela3= CommunityModel("Race Ethnicity Unkown","7%","#80BF3E8C","")
        listDataProgress.add(communityModela3)
        val communityModela4= CommunityModel("Native Hawaiian","51%","#80349460","")
        listDataProgress.add(communityModela4)
        val communityModela5= CommunityModel("Black African American","49%","#80270018","")
        listDataProgress.add(communityModela5)
        val communityModela6= CommunityModel("Asian","42%","#8024418E","")
        ...
        val communityModela8= CommunityModel("Two or more Races","51%","#80918C92","")
